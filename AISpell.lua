...
local UPDATE_FILE_PATH = LIB_PATH.."AISpell.lua"
...
AISpell.ward = function()
	for i=1,7,1 do
		...
		if item ~= nil and (item == 3350 or item == 3340 or item == 2043 or item == 2044 or item == 2045 or item == 2049 or item == 3154 or item == 2050) and  CanUseSpell(ITEM_1 + i - 1) == READY then return ITEM_1 + i - 1 end
	end
	return nil
end
